...
ggplot(data = mpsz3414, 
  ...
  geom_histogram(bins = 20, 
                 color = "white", 
                 fill = "salmon") +
  labs(title = "Are pres-chool evenly distributed in Singapore?",
       subtitle = "The histogram illustrates a right-skewed distribution of pre-school density per square kilometre across \nPlanning Subzones. The tail of the distribution extends to the right, indicating outliers or exceptional Subzones \nwith preschool densities considerably above the norm.",
...
ggplot(data = mpsz3414, 
  ...
  xlim(0, 40) +
  ylim(0, 40) +
  labs(title = "Spatial Distribution of Pre-School Facilities",
